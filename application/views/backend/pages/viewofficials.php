<div class="container-fluid">
   ...
   <p class="mb-4">
      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a class="btn btn-primary" href="<?= base_url('index.php/dashboard/add-officials') ?>"> <i class="fas fa-user-plus"></i> Add Officials </a>
   </p>
   <!-- DataTales Example -->
               ...
               <tbody>
                  ...
                  <td><?= $c++ ?></td>
                     ...
                     <td>
                        ...
                        <button type="button" class="btn btn-success" data-official="<?= $officials_data->id ?>">
                        <i class="fas fa-eye"></i>
                        </button>
                        <button class="btn btn-danger  delete-official-btn" data-official="<?= $officials_data->id ?>"><i class="fas fa-trash"></i></button>
