...
<div class="form-row">
      ...
      <select id="act" name="act" value="<?php echo $complains_data->act; ?>" class="form-control" required>
      ...
      <select id="stat" name="stat" value="<?php echo $complains_data->stat; ?>" class="form-control" required>
      ...
      <label for="loc">Location of Incidence:</label>
        <input type="loc" id="loc" name="loc" value="<?php echo $complains_data->loc; ?>" class="form-control" required/>
        <span class="text-danger"><?=form_error('loc')?></span>
      </div>
      </div>

<div class="form-group text-center">
                <button class="btn btn-primary" onclick="showNotification()">Save Blotter</button>
            </div>
        </form>