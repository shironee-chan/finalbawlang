...
<div id="content">
  <div class="container">
   <h1 class="h3 mb-4">Manage Blotter</h1>
    <form method="POST">
</br> </br> 
...
<div class="form-row">
    ...
    <h2 class="h4 mb-5">Complainee Details</h2>
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" id="name_ex" name="name_ex" class="form-control" />
      ...
      <div class="form-group col-md-2">
        ...
        <select id="prk" name="prk" class="form-control" required>
        <option value="">-- Select Purok --</option>
          <option value="Purok 1">Purok 1</option>
          <option value="Purok 2">Purok 2</option>
          <option value="Purok 3">Purok 3</option>
...
<span class="text-danger"><?=form_error('prk')?></span>
      ...
      <div class="form-group col-md-2">
        ...
        <select id="brgy" name="brgy" class="form-control" required>
        <option value="">-- Select Barangay --</option>
          <option value="Agsoso">Agsoso</option>
          <option value="Badbad Occidental">Badbad Occidental</option>
          <option value="Badbad Oriental">Badbad Oriental</option>
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" id="ag" name="ag" class="form-control" required/>
        <span class="text-danger"><?=form_error('ag')?></span>
      </div>
      <div class="form-group col-md-2">
        <label for="sx">Sex:</label>
        <select id="sx" name="sx" class="form-control" required>
        <option value="">-- Select Sex --</option>
          <option value="Male">Male</option>
          <option value="Female">Female</option>
        </select>
...
<div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="em" id="em" name="em" class="form-control" required/>
...
<div class="form-row">
      ...
      <label for="loc">Location of Incidence:</label>
        ...
        <button type="submit" class="btn btn-primary">Add Complains</button>
      </div>
    </form>
  </div>
</div>
